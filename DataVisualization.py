...
class DataVisiualization:
    def __init__(self, input_data, file_name = None):
        self.input_df = input_data
        self.file_name = file_name

    def data_visualization(self, file_name):
    ...
    def plot_time_series(self, df, file_name):
